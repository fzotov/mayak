...
export function InvoiceDetailPage({ invoice, onBack }: { invoice: any; onBack: () => void }) {
  ...
  const generatePDF = async () => {
    ...
    <table class="req" style="width:100%;border-collapse:collapse;margin-bottom:10pt;font-family:Arial,sans-serif">
      <tr>
        <td rowspan="3" style="border:1px solid #000;width:95px;text-align:center;vertical-align:middle;padding:3px">
      ...
      <tr>
        <td style="border:1px solid #000;padding:3px 6px;font-size:7.5pt;color:#555">Банк получателя</td>
      ...
      <tr>
        <td style="border:1px solid #000;padding:4px 6px;font-size:8pt">
          <div>ИНН&nbsp;&nbsp;500705271772&nbsp;&nbsp;&nbsp;ОГРНИП&nbsp;315500700008401</div>
          <div style="font-weight:bold;margin-top:2px">ИП Зотова Екатерина Викторовна</div>
