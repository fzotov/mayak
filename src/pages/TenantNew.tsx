    ...
    <div style={{ maxWidth: 860 }}>
      ...
      <div style={card}>
        ...
        <div style={grid3}>
          ...
          <div><label style={label}>КПП {form.type !== 'COMPANY' ? '(не требуется)' : ''}</label><input style={inp} value={form.kpp} onChange={f('kpp')} placeholder="770001001" disabled={form.type !== 'COMPANY'} /></div>
